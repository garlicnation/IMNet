...
\textcolor{section}{\Section{References}}

  HDMAS,
  \emph{Hospital Digital Assistant Management System}.
  Lu and Xie, 
  California State University Los Angeles,
  2009.

  IM-Net,
  \emph{Indepdent Music Network}.
  Evelina Lurye and Carlos Estebes, 
  California State University Los Angeles,
  2007.

  AMIRG,
  \emph{Boundary Value Analysis}.
  Testing Excellence, 
  http://www.testingexcellence.com/boundary-value-analysis,
  2012.
